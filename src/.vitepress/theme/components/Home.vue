...
<template>
    <section id="hero">
        ...
        <p class="actions">
            <a class="why" href="/shuttle-recall/why.html">Why?</a>
            <a class="get-started" href="/shuttle-recall/getting-started.html">
                Get Started
    ...
    <section id="highlights" class="vt-box-container">
        ...
        <div class="vt-box">
            <h2>Storage</h2>
            <div>
                Since the storage of events is abstracted any relevant data store may be used. The default mechanism is
